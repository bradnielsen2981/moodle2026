...
if ($hassiteconfig || has_capability('theme/boost_union:configure', context_system::instance())) {
    ...
    if (!$ADMIN->fulltree) {
        ...
        $title = get_string('secondarynavigationposition', 'theme_boost_union', null, true);
        $description = get_string('secondarynavigationposition_desc', 'theme_boost_union', null, true);
