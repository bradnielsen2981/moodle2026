...
/**
 * Format multipageformat section extra logic component.
 *
 * @module     format_multipageformat/section
...
class HighlightSection extends BaseComponent {
    ...
    create() {
        ...
        this.name = 'format_multipageformat_section';
        ...
        // The multi page format section specific actions.
        this.formatActions = {
