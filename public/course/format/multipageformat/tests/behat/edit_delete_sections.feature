@format @format_multipageformat
Feature: Sections can be edited and deleted in multi page format
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Course 1 | C1        | multipageformat | 0             | 5           | 1            |
      | Course 2 | C2        | multipageformat | 0             | 1           | 0            |
  ...
  Scenario: View the default name of the general section in multi page format
    Given I am on "Course 1" course homepage with editing mode on
    When I edit the section "0"
    Then the field "Section name" matches value ""
    And I should see "General"

  Scenario: Edit the default name of the general section in multi page format
    Given I am on "Course 1" course homepage with editing mode on
  ...
  @javascript
  Scenario: Inline edit section name in multi page format
    Given I am on "Course 1" course homepage with editing mode on
  ...
  Scenario: Deleting the last section in multi page format
    Given I am on "Course 1" course homepage with editing mode on
  ...
  Scenario: Deleting the middle section in multi page format
    Given I am on "Course 1" course homepage with editing mode on
  ...
  @javascript
  Scenario: Adding sections at the end of a multi page format
    Given I am on "Course 1" course homepage with editing mode on
  ...
  @javascript
  Scenario: Adding sections between in multi page format
    Given I am on "Course 1" course homepage with editing mode on
