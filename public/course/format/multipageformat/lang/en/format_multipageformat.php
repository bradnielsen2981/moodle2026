...
/**
 * Strings for component Multi page course format.
 *
...
$string['pluginname'] = 'Multi page format';
$string['plugin_description'] = 'The course is divided into customisable sections.';
$string['privacy:metadata'] = 'The Multi page format plugin does not store any personal data.';
